...
namespace msmSmartTools {
    ...
    // --- Blocs “collège” : stabilité par couleur
    ...
    // --- Blocs “collège” : approcher une couleur
    ...
    // ----- Nouveau bras 3 axes pédagogique (servos 1,2,3)
    ...
    // ----- Nouvelles missions pédagogiques prêtes à l'emploi
